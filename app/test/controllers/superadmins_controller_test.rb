...
class SuperadminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create superadmin" do
    assert_difference('Superadmin.count') do
      post superadmins_url, params: { superadmin: { email: @superadmin.email, geofence: @superadmin.geofence, lastname: @superadmin.lastname, name: @superadmin.name, password: @superadmin.password } }
    end
  ...
  test "should update superadmin" do
    patch superadmin_url(@superadmin), params: { superadmin: { email: @superadmin.email, geofence: @superadmin.geofence, lastname: @superadmin.lastname, name: @superadmin.name, password: @superadmin.password } }
